...
public abstract class TaskParameters {
    ...
    public abstract DataRunnable generateAction(Context context);

    public interface DataRunnable {
    ...
    public static class DescriptionBuilder {
        ...
        public DescriptionBuilder(CharSequence charSequence) {
            append(charSequence);
        }
    ...
    public static void writeClass(Class<?> clazz, Output output) {
        output.writeString(clazz.getName());
    }

    public static boolean readClass(Class<?> clazz, Input input) {
